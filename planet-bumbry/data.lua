...
require("__planet-bumbry__.prototypes.entity")
require("__planet-bumbry__.prototypes.recipe-category")
require("__planet-bumbry__.prototypes.recipe")
require("__planet-bumbry__.prototypes.technology") -- Added technology
